                    ...
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg close-rate">
                                ...
                                <p
                                    class="m-0 small text-uppercase text-muted"
                                    v-if="issues.closeRate.highest.close_rate"
                                >
                                    Highest:
			  ...
			  labels: {
				...
				template: '#= kendo.format(\'{0:P}\', percentage)#'
                        ...
                        <div class="comp-label chart-label">
                            <div class="comp-label chart-label"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
import { IssuesProcessor } from "~/assets/js/issues-processor";
    ...
    created() {
        ...
        that.ghData = new kendo.data.DataSource({
            transport: {
                read: {
                    url:
                        "https://api.github.com/repos/telerik/kendo-ui-core/issues",
                    data: {
                        state: "all",
                        page: 1,
                        per_page: 100
                    ...
                    beforeSend: function(req) {
                        req.setRequestHeader(
                            "Authorization",
                            "token b95116792cba5a8169a1ec10640d8c16535c6419"
                        );
                    }
                }
            },
    ...
    computed: {
        issues() {
            return this.response.length > 0
                ? ghIssuesProcessor.process(this.response, this.days)
                : null;
        },
        days() {
